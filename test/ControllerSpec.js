...
describe("controller", function() {
  ...
  it("should show entries on start-up", function() {
    // TODO: write test
    var todos = [{ title: "my_todo_1" }, { title: "my_todo_2" }];
    setUpModel(todos);
  ...
  describe("routing", function() {
    ...
    it("should show active entries", function() {
      // TODO: write test
      var todos = [{ title: "my_todo_1", completed: false }];
      setUpModel(todos);
    ...
    it("should show completed entries", function() {
      // TODO: write test
      var todos = [{ title: "my_todo_1", completed: true }];
      setUpModel(todos);
  ...
  describe("toggle all", function() {
    beforeEach(function() {
      var todos = [
        { id: 1, title: "my_todo_1", completed: false },
        { id: 2, title: "my_todo_2", completed: false }
      ];
      setUpModel(todos);
    ...
    it("should toggle all todos to completed", function() {
      ...
      var callsCount = model.update.calls.count();
  ...
  describe("element removal", function() {
    it("should remove an entry from the model", function() {
      // TODO: write test
      var todos = [
        { id: 1, title: "my_todo_1", completed: true },
        { id: 2, title: "my_todo_2", completed: true }
      ];
